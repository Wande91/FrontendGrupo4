...
h1 {
  ...
  .navegacion{
    width: 100%;
    background: linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 0.5)), url(./assets/fondo6r.webp);
    background-position: top;
    background-size: 100%;
  }

  .departamentos{
    background: linear-gradient(rgba(0, 0, 0, 0.5),rgba(0, 0, 0, 0.5)), url(./assets/fondo5.webp);
    background-position: top;
    background-size: 100%;
  }
  ...
  .cabecera #buscar input:active,.cabecera #buscar input:focus {
